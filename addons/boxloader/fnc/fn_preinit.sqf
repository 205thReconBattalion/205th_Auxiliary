["boxloader_hidecargo_enabled","CHECKBOX",["Enable ""Hide Cargo"" feature","Designed to fix issues with the deprecated retrofit system. Can be changed mid-mission."],"Boxloader",false,true] call CBA_settings_fnc_init;
