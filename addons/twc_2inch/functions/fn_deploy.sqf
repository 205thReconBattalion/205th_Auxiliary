...
_HECount = {_x == "twc_2inch_he_1rnd"} count _magazines;
_smokeCount = {_x == "twc_2inch_smoke_1rnd"} count _magazines;
_IllumCount = {_x == "twc_2inch_illum_1rnd"} count _magazines;
_loadedMag = (secondaryWeaponMagazine _unit) select 0;

switch (_loadedMag) do
{
	case "twc_2inch_he_1rnd": {_HECount = _HECount + 1};
	case "twc_2inch_smoke_1rnd": {_smokeCount = _smokeCount + 1};
	case "twc_2inch_illum_1rnd": {_IllumCount = _IllumCount + 1};
	default {};
};

for "_i" from 1 to _HECount do {
	_mortar addMagazineTurret ["twc_2inch_he_1rnd", [0]];
};
for "_i" from 1 to _smokeCount do {
	_mortar addMagazineTurret ["twc_2inch_smoke_1rnd", [0]];
};
for "_i" from 1 to _IllumCount do {
	_mortar addMagazineTurret ["twc_2inch_illum_1rnd", [0]];
};
